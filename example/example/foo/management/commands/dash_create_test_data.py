...
from dash.contrib.plugins.dummy.dash_plugins import DummyPlugin, LargeDummyPlugin, LargeDummyPortraitPlugin
from dash.contrib.plugins.memo.dash_plugins import MemoPlugin, BigMemoPlugin, BigTinyMCEMemoPlugin
from dash.contrib.plugins.news.dash_plugins import HugeNewsPlugin
from dash.contrib.plugins.rss_feed.dash_plugins import ReadRSSFeedPlugin
from dash.contrib.plugins.url.dash_plugins import URLPlugin
from dash.contrib.plugins.video.dash_plugins import VideoPlugin, BigVideoPlugin
...
def create_dashboard_entries(user, workspace=None, mixed_order=False):
    ...
    dashboard_entry = DashboardEntry(
        ...
        layout_uid = AndroidLayout.uid,
        placeholder_uid = AndroidMainPlaceholder.uid,
        plugin_uid = BigTinyMCEMemoPlugin.uid,
    ...
    dashboard_entry = DashboardEntry(
        ...
        layout_uid = AndroidLayout.uid,
        placeholder_uid = AndroidMainPlaceholder.uid,
        plugin_uid = LargeDummyPlugin.uid,
    ...
    dashboard_entry = DashboardEntry(
        ...
        layout_uid = AndroidLayout.uid,
        placeholder_uid = AndroidShortcutsPlaceholder.uid,
        plugin_uid = LargeDummyPortraitPlugin.uid,
        plugin_data = clean_extra_spaces("""{"text": "", "lipsum_language": "en", "show_title": false,
            "generate_lipsum": false}"""),
        position = 8
        )
...
def create_news_and_rss_dashboard_entries(user, workspace):
    ...
    dashboard_entry = DashboardEntry(
        ...
        layout_uid = AndroidLayout.uid,
        placeholder_uid = AndroidMainPlaceholder.uid,
        plugin_uid = ReadRSSFeedPlugin.uid,
