...
__all__ = ('URLBootstrapTwo1x1Bootstrap2FluidMainWidget', 'URLBootstrapTwo2x2Bootstrap2FluidMainWidget')

from dash.contrib.plugins.url.dash_widgets import BaseURLWidget
